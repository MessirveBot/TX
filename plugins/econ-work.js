...
if (new Date - global.db.data.users[m.sender].lastwork < 600000) throw `*estas cansado espera ${msToTime(time - new Date())} para volver a trabajar!*`
...
"Ayudas a moderar el grupo de Sebastian por", "Diseñaste un logo para *TX* por", 
"Moderaste el grupo cuando *TX* no estaba, el pago fue", 
"¡Trabajó lo mejor que pudo en una imprenta que estaba contratando y ganó su bien merecido!", 
"Trabajas como podador de arbustos para *Sebastian* y ganas", "La demanda de juegos para dispositivos móviles ha aumentado, por lo que creas un nuevo juego lleno de micro-transacciones. Con tu nuevo juego ganas un total de", 
